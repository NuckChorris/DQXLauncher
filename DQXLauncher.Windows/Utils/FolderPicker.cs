...
// Adapted from https://stackoverflow.com/a/66187224
// Licensed under CC-BY-SA-4.0 https://creativecommons.org/licenses/by-sa/4.0/
// Original author: https://stackoverflow.com/users/403671/simon-mourier
// Edited by "Community" and then adapted by us.
public class FolderPicker
{
    ...
    protected virtual int SetOptions(int options)
    {
        ...
        if (Multiselect) options |= (int)FOS.FOS_ALLOWMULTISELECT;
    ...
    {
        owner ??= App.AppWindow;
        return ShowDialog(WindowNative.GetWindowHandle(owner), throwOnError);
    }
    ...
    public virtual bool? ShowDialog(IntPtr owner, bool throwOnError = false)
    {
        ...
        for (var i = 0; i < count; i++)
        {
            ...
            if (path != null) _resultPaths.Add(path);
            if (name != null) _resultPaths.Add(name);
