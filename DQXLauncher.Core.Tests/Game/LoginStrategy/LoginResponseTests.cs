...
namespace DQXLauncher.Core.Tests.Game.LoginStrategy;
...
public class LoginResponseTests
{
    ...
    {
        var request = new HttpRequestMessage(HttpMethod.Post, "http://dqx-login.square-enix.com/oauth/sp/sso/dqxwin/login");
